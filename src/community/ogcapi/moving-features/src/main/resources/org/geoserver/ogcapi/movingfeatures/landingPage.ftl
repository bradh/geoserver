...
<#include "common-header.ftl">
  ...
  <h1>${service.title!"GeoServer Moving Features 1.0 Service"}</h1>
  <p class="my-4">
    ${service.abstract!""}<br/>
    This is the landing page of the Moving Features 1.0 service, providing links to the service API and its contents.<br/>
  </p>
