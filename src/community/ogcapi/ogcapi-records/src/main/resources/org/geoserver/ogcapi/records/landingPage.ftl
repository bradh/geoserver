<#include "common-header.ftl">
   <div id="content">
       <h2>${service.title!"GeoServer Records 1.0 Service"}</h2>
       <p>${service.abstract!""}<br/>
       This is the landing page of the Records 1.0 service, providing links to the service API and its contents.
       <br/> 
       ...
       <p>The <a id="htmlApiLink" href="${model.getLinkUrl('api', 'text/html')!}"> API document</a> provides a machine processable description of this service API conforming to OpenAPI 3.
       <br/> 
       ...
       <h2>Conformance</h2>
       <p>The <a id="htmlConformanceLink" href="${model.getLinkUrl('conformance', 'text/html')!}"> conformance page</a> provides a list of the OGC API conformance classes implemented by this service. 
       <br/> 
       ...
       <#-- TODO when upgrading Freemarker add ?no_esc to avoid html escaping --> 
